              ...
              child: BlocBuilder<CategoryListBloc, CategoryListState>(
                builder: (context, state) {
                  if (state is CategoryListLoading) {
                    ...
                    if (categories.last.title != '+   Add' && categories.last.color != 100)
                        categories.insert(state.categories.length,
                            CategoryModel(title: '+   Add', color: 100));
                    return DropdownButton(
                      ...
                      onChanged: (value) async {
                        ...
                        if ((value as CategoryModel).title == '+   Add' &&
                            (value).color == 100) {
                        ...
                        // switch ((value as CategoryModel).title) {
                        //   case '+ Add':
                        //     Navigator.push(
                        //         context,
                        //         MaterialPageRoute(
                  ...
                  if (_formKey.currentState!.validate()) {
                    DateTime reminderDate = DateTime(
                      ...
                      (global.store.get('dateTimeCalender') as DateTime?)
                              ?.day ??
                          DateTime.now().day,
                      (global.store.get('reminderTime') as TimeOfDay?)
                              ?.hour
                              .toInt() ??
                          DateTime.now().hour,
                      (global.store.get('reminderTime') as TimeOfDay?)
                    ...
                    DateTime taskDate = DateTime(
                      ...
                      (global.store.get('dateTimeCalender') as DateTime?)
                              ?.day ??
                          DateTime.now().day,
                      (global.store.get('TaskTime') as TimeOfDay?)
                              ?.hour
                              .toInt() ??
                          DateTime.now().hour,
                      (global.store.get('TaskTime') as TimeOfDay?)
