...
import 'package:to_do_list_pro_project/screens/main_screen/goal.dart';
import 'package:to_do_list_pro_project/screens/main_screen/task.dart';
import 'package:to_do_list_pro_project/screens/main_screen/wheel.dart';
...
class _MyBottomNavbarState extends State<MyBottomNavbar> {
  ...
  void onTappedBar(int index) {
    ...
    if (_currentIndex == 1)
      BlocProvider.of<PercentageBloc>(context)..add(ReloadPercentage());
        ...
        items: [
          BottomNavigationBarItem(
            icon: Container(
                ...
                height: 50.0,
                child: new Icon(Icons.track_changes_outlined)),
            label: "Цели",
          ),
          BottomNavigationBarItem(
            icon: Container(
          ...
          BottomNavigationBarItem(
            icon: Container(
                width: (MediaQuery.of(context).size.width - 30) / 3,
                height: 50.0,
                child: new Icon(Icons.fact_check_outlined)),
            label: "Задачи",
          ),
        ],
      ),
